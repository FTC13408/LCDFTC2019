...
/*
            ...
            baseRobot.StopRobot();
*/
            //Step 7: Drive ALL the way to Crater

            //Step 7.1: Turn right to face wall
            baseRobot.DriveAWDRobot(.8, -.8);
            sleep(800);
            baseRobot.StopRobot();

            //Move forward to approach wall
            baseRobot.DriveAWDRobot(.6, .6);
            sleep(300);
            baseRobot.StopRobot();

            //Step 7.2: Turn right while moving to face crater, hugging the wall
            baseRobot.DriveAWDRobot(.5, .5);
            sleep(900);
            baseRobot.StopRobot();

            //Step 7.4: Turn right to face crater
            baseRobot.DriveAWDRobot(.6, -.6);
            sleep(400);
            baseRobot.StopRobot();

            //Step 7.5: Drive facing crater
            baseRobot.DriveAWDRobot(0.8, 0.8);
            sleep(300);
            baseRobot.StopRobot();

            //Step 7.5: Turn right to face crater
            baseRobot.DriveAWDRobot(.6, -.6);
            sleep(150);
            baseRobot.StopRobot();

            //Step 7.5: Drive into crater
            baseRobot.DriveAWDRobot(0.8, 0.8);
            sleep(1700);
            baseRobot.StopRobot();
